  ...
  const analyzeWithGemini = async (file) => {
    ...
    try {
      ...
      const prompt = `
                ...
                Step 3: If NAY, give 2–3 specific improvement suggestions. Give 3 images or URLs. Make sure they are royalty free images. Give them under a custom object called recommendedImages
